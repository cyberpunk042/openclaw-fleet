...
**Expected:** Subtask. No contributions required (skip_contributions type). Parent task shown.
...
# YOUR TASK: Implement AgentGrid component
- ID: task-sub
- Priority: medium
- Type: subtask
- Parent: task-a1b
...
> Create AgentGrid showing 10 agent cards color-coded by status
